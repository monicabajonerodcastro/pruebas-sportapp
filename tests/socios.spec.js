...
const _JSON_SOCIOS = {
    ...
    "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MTU4NDIyOTgsImlhdCI6MTcxNTg0MDQ5OCwic3ViIjoiZjI5MjBmOWItZjA3MS00NGVkLTkwMzUtYzBmMDdlYzY4YzNmIn0.z8pazE3nqq4TyPvivaVUPMVdvp9eWFQj-kVhh59Tu9E"
}
...
test.describe('Pantalla Socios', () => {
    ...
    test('Debería buscar por texto', async ({ page }) => {
        ...
        await page.getByPlaceholder("Buscar socio de negocio...", {exact: true}).fill("Fern")
